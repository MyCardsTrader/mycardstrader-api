...
describe("CardService", () => {
  ...
  describe("Create a card", () => {
    ...
    it("Should throw an HttpException", async () => {
      ...
      // When
      //Then
      await expect(service.createCard(cardDto, userId)).rejects.toThrow(
        HttpException,
      );
    });
  });
  ...
  describe("Import cards", () => {
    ...
    it("Should throw an HttpException", async () => {
      ...
      // When
      //Then
      await expect(service.importCards(cardsDto, userId)).rejects.toThrow(
        HttpException,
      );
    });
  });
  ...
  describe("Delete a card", () => {
    ...
    it("Should throw HttpException on findOneAndDelete card", async () => {
      ...
      // When
      // Then
      await expect(service.deleteCard(cardDeleteDoc.id)).rejects.toThrow(
        HttpException,
      );
    });
  ...
  describe("Find cards by user", () => {
    ...
    it.each([SortOrder.ASC, SortOrder.DESC])(
      "Should sort and limit cards by creation date (%s)",
      async (order) => {
        Mock(CardTestModel).toReturn([cardDoc], "find");
    ...
    it("Should throw HttpException on find cards by user", async () => {
      ...
      // When
      // Given
      await expect(service.findCardByUser("userId")).rejects.toThrow(
        HttpException,
      );
    });
  });
  ...
  describe("Find cards by id", () => {
    ...
    it("Should find no cards by id", async () => {
      ...
      // When
      // Then
      await expect(service.findCardById(cardId)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe("UpdateCard", () => {
    ...
    it("Should throw HttpException", async () => {
      ...
      // When
      // Then
      await expect(service.updateCard(cardId, updateDto)).rejects.toThrow(
        HttpException,
      );
    });
  });
